    ...
    while attempts < max_attempts:
        ...
        if guess == secret_code:
            ...
            if attempts == max_attempts:
                ...
                num_correct_digits = sum(1 for x, y in zip(str(guess), str(secret_code)) if x == y)
                print("Incorrect guess. Attempts left:", max_attempts - attempts, "Digits correct:", num_correct_digits)
